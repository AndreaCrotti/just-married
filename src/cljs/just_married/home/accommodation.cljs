...
(def ^:private accommodation-dict
  {:en {:suggest  "We suggest booking at the Hotel Villa Immacolata."
        :code     "The code to get a 10% discount is: \"matrimonio Verrucci\" and prices range from 58 € for the single to the 89 € for the triple room, breakfast included."
   ...
   :it {:suggest "Suggeriamo di pernottare all'Hotel Villa Immacolata."
        ;;TODO: verify if the code can be used directly on booking.com or how else
        :code    "Il codice per ottenere uno sconto del 10% è: \"matrimonio Verrucci\", e i prezzi variano dai 58 € per la singola ai 89 € per la tripla, colazione inclusa."
