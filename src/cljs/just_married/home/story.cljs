...
(def ^:private story-dict
  {:en {:story "Once upon a time,
...
"
   ...
   :it {:story "e vissero per sempre felici e contenti"
...
(defn story
  []
  (let [expanded-story (subscribe [:expanded-story])
        text (translate story-dict :story)
